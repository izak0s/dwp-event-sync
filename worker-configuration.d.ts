/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging --env-interface=CloudflareBindings` (hash: fcf437db42ee6fedb8b5b7cc9e9bc24b)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 
interface __BaseEnv_CloudflareBindings {
	WP_BASE_URL: "https://werkplek.wptwantemp.nl";
	WP_POST_STATUS: "private";
	SITE_TIMEZONE: "Europe/Amsterdam";
	WP_USERNAME: string;
	WP_APP_PASSWORD: string;
	ADMIN_TOKEN: string;
	SPACEBRING_CLIENT_ID: string;
	SPACEBRING_CLIENT_SECRET: string;
	SPACEBRING_LOCATION_REF: string;
	SPACEBRING_EVENT_URL_BASE: string;
	SPACEBRING_WEBHOOK_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WP_BASE_URL" | "WP_POST_STATUS" | "SITE_TIMEZONE" | "WP_USERNAME" | "WP_APP_PASSWORD" | "ADMIN_TOKEN" | "SPACEBRING_CLIENT_ID" | "SPACEBRING_CLIENT_SECRET" | "SPACEBRING_LOCATION_REF" | "SPACEBRING_EVENT_URL_BASE" | "SPACEBRING_WEBHOOK_SECRET">> {}
}
